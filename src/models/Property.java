...
public class Property implements Tileable, Ownable 
{
	...
	//totalHouses and totalHotels are static because there is a limited amount of houses/hotels
	...
	public Property(String t,String n,int p,int mp,int r,int hr,String d)
	{
		...
		description=d;
		owner=null;
		//depending what side of the board the property is, determines price of houses/hotels
		switch(TYPE)
		{
	...
	//updates the price of the rent depending on number of houses/hotels or if it's mortgaged 
	public void updateRent()
	{
		...
		else
		{
			...
			switch(houses)
			{
				case 0:rent=hasMonopoly()?baseRent*2:baseRent;break;
